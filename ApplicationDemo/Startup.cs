...
namespace ApplicationDemo
{
    public class Startup
    {
        ...
        {
            services.Configure<ApplicationSettings>(Configuration.GetSection("JwtSettings"));
            ...
            services.AddIdentity<AppUser , IdentityRole>().AddEntityFrameworkStores<ApplicationDBContex>();
